          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="relative hidden sm:block">
                ...
                <input placeholder="Search events..." className="pl-10 w-52 lg:w-72 border border-gray-200 dark:border-input rounded-md h-9 text-sm px-3 bg-white dark:bg-input"
                  onKeyDown={(e) => e.key === 'Enter' && navigate('/user/events')} />
              </div>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button onClick={toggleTheme} className="p-2 text-gray-500 dark:text-muted-foreground hover:text-gray-900 dark:hover:text-foreground hover:bg-gray-100 dark:hover:bg-accent rounded-full transition-colors">
                {isDarkMode ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
              </button>
              <NavLink to="/user/notifications" className="relative p-2 text-gray-500 dark:text-muted-foreground hover:bg-gray-100 dark:hover:bg-accent rounded-full transition-colors">
              ...
              <div className="hidden sm:flex items-center space-x-2 border-l border-gray-200 dark:border-border pl-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-500 dark:text-muted-foreground text-xs">Member</p>
                </div>
              </div>
            </div>
          </div>
