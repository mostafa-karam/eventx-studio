...
// @access  Private/Admin
exports.getAttendeeInsights_6 = async (req, res) => {
  try {
...
// @access  Private/Admin
exports.getAllAttendeeInsights_7 = async (req, res) => {
  try {
...
// @access  Private/Admin
exports.getAttendeeInsights_8 = async (req, res) => {
  try {
    const { eventId } = req.query;
...
// @access  Private/Admin
exports.getAllAttendeeInsights_9 = async (req, res) => {
  try {
